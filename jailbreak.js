(function () {
    ...
    if (stateEl) {
        var DONE_RE = /ALL DONE|\bSUCCESS\b|\u0627\u0634\u062a\u063a\u0644|\u0646\u062c\u0627\u062d/i;
        var REBOOT_RE = /REBOOT/;
        var FAIL_RE = /FAILED|no commit|UNSUPPORTED|missing|NO REBOOT|does not|did not|cache failed|\u0641\u0634\u0644/i;
        ...
        function handleState() {
            ...
            if (REBOOT_RE.test(t) && !/NO REBOOT/.test(t)) {
                setStateText(t, AR_FAIL); return;
            }
