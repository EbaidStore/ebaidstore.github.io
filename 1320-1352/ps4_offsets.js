...
PS4["13.50"] = {
  fw_status:
    ...
    "kpatch=1350.bin-BUILT-10/10-neg-controls-pass-UNTESTED-on-hw payload=payload.bin bug=663",
  ...
  payload: "payload.bin", // 13.52 GoldHEN
};
...
PS4["13.52"] = Object.assign({}, PS4["13.50"], {
  ...
  fw_status:
    ...
    "payload=payload.bin-13.52-GoldHEN bug=663",
});
...
payload: "payload.bin", // 13.52 GoldHEN; replaces the non-shipped 13.00 placeholder
fw_status:
    ...
    "kpatch=1302.bin-HW-PROVEN-KEXEC-rc0 payload=payload.bin bug=663",
});
...
fw_status:
    ...
    "kpatch=1302.bin-shared-HW-PROVEN payload=payload.bin bug=663",
});
